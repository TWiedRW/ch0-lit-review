...
Several other studies have shown that other types of "chart junk" can increase recollection, but at the cost of participants needing longer times to process the charts [@bateman2010; @borgo2012; @peña2020]. The increase of time for reading 3D bar charts was noted by @fischer2000, lending some credibility
...
Although @tufte2001 argued against the use of 3D charts when possible, studies involving direct comparisons of 2D and 3D bar charts have not provided conclusive evidence that depth cues should be avoided at all costs. .....

### Accuracy

Accuracy is a common metric in studies comparing 2D and 3D bar charts. When only measuring accuracy, 3D charts tend to be less accurate than their 2D counterparts [@zacks1998; @stewart2009].

![Figure in Statistical Graphics: Design Principles and Practices. The viewing angle for this chart would have viewers overestimate the values of the ](images/skewed-angle.jpg){width="3.35in"}

@zacks1998 found that 3D depth cues tended to lower accuracy of judgements, but only when the stimuli was present when making judgements. @zacks1998 also noted that

-   @siegrist1996, 2D and 3D not that different, but bar positions is important! Also more time needed too
