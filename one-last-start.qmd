...
![3D-printed treemap created displaying Gross National Income for 130 countries [@huronMakingDataPhysical2023, pg. 217]. The two 3D prints on the bottom have additional information overlaid on top of the treemap as 2D displays.](images/treemap-3d.png){#fig-3d-treemap fig-scap='3D-printed treemap'}
...
![Original 3D printed chart from WSJ](images/wsj-print.jpg){#fig-wsj-orig fig-height="2in" fig-scap='Original WSJ 3D print'}

![Replicated print created in 2025](images/wsj-myprint.jpg){#fig-wsj-myprint fig-height="2in" fig-scap='Replicated WSJ 3D print'}
...
::: {#fig-make-bar-3d layout-ncol="4" fig-scap="2D bar to 3D bar construction"}
...
![Figure in Statistical Graphics: Design Principles and Practices. The viewing angle for this chart would have viewers overestimate the values of the bars](images/skewed-angle.jpg){#fig-skewed width="3.35in" fig-scap='Skewed view overestimates bar heights'}
...
![Bar chart with strictly positive values](images/preferance-example1.png){#fig-ag-bar-pos fig-height="3in" fig-scap='Positive-value 3D bar chart'}

![Bar chart with negative values](images/preferance-example2.png){#fig-ag-bar-neg fig-height="2in" fig-scap='Negative-value 3D bar chart'}
